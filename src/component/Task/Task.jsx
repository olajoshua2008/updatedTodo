        ...
        <div className="popup">
          ...
          <div className="content">
            <textarea 
             ...
             <div className="time">
             from:<input type="time" required onChange={(e) =>{setFrom(e.target.value)}} className='from' value={from} />
             to:<input type="time" required onChange={(e) =>{setTimeTO(e.target.value)}} value={timeTO} className='timeto'/>
             </div>
          </div>
          <div className="btn">
